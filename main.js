...
//狗狗貓貓 監聽按鈕
document.querySelector('#dog-btn-section').addEventListener('click', showDogContent);
document.querySelector('#cat-btn-section').addEventListener('click', showCatContent);
